...
ttx -b -d "%cd%" -m PingFangSC-Regular.otf MicrosoftYaHei.ttx
ttx -b -d "%cd%" -m PingFangSC-Regular.otf MicrosoftYaHeiUI.ttx
ttx -b -d "%cd%" -m PingFangSC-Light.otf MicrosoftYaHeiLight.ttx
ttx -b -d "%cd%" -m PingFangSC-Light.otf MicrosoftYaHeiUILight.ttx
ttx -b -d "%cd%" -m PingFangSC-SemiBold.otf MicrosoftYaHei-Bold.ttx
ttx -b -d "%cd%" -m PingFangSC-SemiBold.otf MicrosoftYaHeiUI-Bold.ttx
